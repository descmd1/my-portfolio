        ...
        <>
           <section className="showcase">
                <div className="overlay flex flex-col items-center justify-center text-black 
                    ...
                    text-right mb-10 flex flex-col items-center justify-center mt-20">Hi, I am Christopher Aondoakaa,<span  
                    ...
                    <div className="overlay flex flex-col items-center justify-center text-black
                        ...
                        text-right mb-10 flex flex-col items-center justify-center mt-20 sm:text-2xl">I also create <span
                         className="text-green-500">brand awareness</span> for small businesses</h1>
                    </div>
